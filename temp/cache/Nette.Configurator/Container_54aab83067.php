<?php
// source: C:\Program Files (x86)\Ampps\www\hackaton\app/config/config.neon 
// source: C:\Program Files (x86)\Ampps\www\hackaton\app/config/config.local.neon 

class Container_54aab83067 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => 'C:\Program Files (x86)\Ampps\www\hackaton\app',
			'wwwDir' => 'C:\Program Files (x86)\Ampps\www\hackaton\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\Program Files (x86)\Ampps\www\hackaton\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Program Files (x86)\Ampps\www\hackaton\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Program Files (x86)\Ampps\www\hackaton\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Program Files (x86)\Ampps\www\hackaton\app/../temp/cache',
	...
	{
		return new Container_54aab83067_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_54aab83067_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_54aab83067 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\Program Files (x86)\Ampps\www\hackaton\app/../temp/cache/latte');
